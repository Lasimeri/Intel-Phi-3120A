...
| [2026-09-20-zstd-vpu.md](results/2026-09-20-zstd-vpu.md) | Why zstd cannot use the VPU: KNC has no byte or word vector instructions, and the one path that can vectorise is already bandwidth-bound |
