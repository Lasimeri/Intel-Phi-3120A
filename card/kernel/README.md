...
| 0025 | `x86/knc: /dev/phiblk0, a block device served by the host over ring channel 4` | `kernel/knc_blk.c`, `asm/knc_ring.h` | persistent storage: blk-mq over ring kind 4, 512 KiB uncached bounce slots (host aperture writes are not snooped by the cores; measured 2026-09-16), disk registered from a workqueue once the host answers identify |
